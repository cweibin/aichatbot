    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new SaInterceptor(handle -> {
                    SaRouter
                            .match("/**")
                            .notMatch("/tools/**")
                            .notMatch("/core/common/createVerifyCode/*")
                            .notMatch("/core/user/login")
                            .notMatch("/core/user/registerOrBind")
                            .notMatch("/core/user/register/sendIdentifyingCode")
                            .notMatch("/tools/order/ekeyPaidApiHook")
